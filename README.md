...
The **source code** of this project (HTML, CSS, and JavaScript) is released under the **MIT License** (see [`LICENSE`](LICENSE)); you are welcome to study, reuse, and build on it. The **personal content** (the biography and written text, the profile photograph, the certificates, and the visual design) is **© 2026 Özcan Orhan Demirci, all rights reserved**, and may not be reused or republished without permission.

**Türkçe**

Projenin **kaynak kodu** (HTML, CSS ve JavaScript) **MIT Lisansı** ile yayımlanmıştır (bkz. [`LICENSE`](LICENSE)); inceleyebilir, yeniden kullanabilir ve üzerine geliştirebilirsiniz. **Kişisel içerik** (özgeçmiş ve metinler, profil fotoğrafı, sertifikalar ve görsel tasarım) **© 2026 Özcan Orhan Demirci, tüm hakları saklıdır** olup izinsiz kullanılamaz veya yeniden yayımlanamaz.
