...
# Portfolio Website Project for Web Programming Course 
# 👨‍💻 Personal Portfolio Website

This repository contains my personal portfolio website, designed and developed as a midterm assignment for the **Web Programming** course. The project showcases my academic background, technical skills, projects, and certificates in a clean, responsive interface.

## 🚀 Live Demo

👉 **[Click here to view the live website](https://ozcanorhandemirci.github.io/Portfolio-Web-Project/)
...
* **Modals:** * **Image Modal:** Clickable certificate and profile images that expand for better viewing.
    * **Contact Modal:** A pop-up window to display contact information securely.
* **Professional Assets:** Includes a custom Favicon and Manifest for mobile web app support.
